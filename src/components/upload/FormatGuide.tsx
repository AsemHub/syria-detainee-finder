...
const formatGuide = {
  ...
  'تاريخ_آخر_مشاهدة | date_of_detention': 'تاريخ آخر مشاهدة (YYYY-MM-DD) (بين 1900 والتاريخ الحالي)',
  'آخر_مكان | last_seen_location': 'آخر مكان شوهد فيه (نص عربي)',
  'معلومات_الاتصال | contact_info': 'معلومات الاتصال (مطلوب)',
  ...
  'الحالة | status': 'الحالة (القيم المقبولة: معتقل، مفقود، محرر، متوفى، غير معروف)',
  'ملاحظات | additional_notes': 'ملاحظات إضافية (نص عربي)',
  'المنظمة | organization': 'المنظمة المقدمة للمعلومات'
};
